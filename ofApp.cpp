...
void ofApp::setup() {
	...
	vector<string> file_path_list = {"Pexels Videos 2921.mp4", "Pexels Videos 1333384.mp4"};
...
void ofApp::draw() {
	...
	for (int k = 0; k < 2; k++) {
		...
		ofPushMatrix();
		ofTranslate(0, k * this->cap_size.height * 1.1 - this->cap_size.height * 0.55 - this->rect_size * 0.5, 0);
